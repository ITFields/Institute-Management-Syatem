...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $update = "UPDATE users SET name=?, email=?, password=?, course_name=?, start_date=?, end_date=?, fee=? WHERE id=?";
    $stmt = mysqli_prepare($conn, $update);
    mysqli_stmt_bind_param($stmt, 'sssssssi', $name, $email, $password, $course, $start, $end, $fee, $id);
